...
import cat.urv.cloudlab.soundless.databinding.FragmentTutorialSecondBinding
...
class TutorialSecondFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentTutorialSecondBinding.inflate(layoutInflater)
        ...
        val actionSkipToMain = TutorialSecondFragmentDirections.actionNavTutorialSecondToNavMain()
        if (skip) navController.navigate(actionSkipToMain)

        with(binding) {
            nextButton.setOnClickListener {
                val action = TutorialSecondFragmentDirections
                    .actionNavTutorialSecondToNavTutorialThird()
